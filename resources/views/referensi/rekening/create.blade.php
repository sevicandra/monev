...
@section('content')
    <div class="bg-primary p-4">
        <h1 class="text-xl text-primary-content">Tambah Referensi Rekening</h1>
    </div>
    <div class="px-4">
        <form action="" method="post" autocomplete="off">
            ...
            <div class="form-control w-full max-w-xs">
                ...
                <select name="bank" id="bank"
                    ...
                    <option value="Bank Syariah Indonesia" @if (old('bank') === 'Bank Syariah Indonesia') selected @endif>Bank
