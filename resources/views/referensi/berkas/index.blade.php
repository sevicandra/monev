...
<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row mb-3">
        <div class="col-lg-7">
            <a href="/berkas/create" class="btn btn-sm btn-outline-secondary mt-1 mb-1"> Tambah Data</a>
        </div>
        <div class="col-lg-5">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->kodeberkas }}</td>
                            <td>{{ $item->namaberkas }}</td>
                            <td class="pb-0 pr-0">
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="/berkas/{{ $item->id }}/edit" class="btn btn-sm btn-outline-secondary pt-0 pb-0">Ubah</a>
