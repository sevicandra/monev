        ...
        <table class="table border-collapse w-full max-w-2xl">
            <thead class="text-center">
                <tr class="align-middle">
                    ...
                    <th class="border border-base-content">Kode Golongan</th>
                    <th class="border border-base-content">Tarif PPH</th>
            ...
            <tbody>
                ...
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td class="border border-base-content text-center">{{ $item->kodegolongan }}</td>
                        <td class="border border-base-content text-center">{{ $item->tarifpph }}</td>
