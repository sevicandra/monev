        ...
        <x-table class="collapse w-full max-w-2xl">
            ...
            <x-table.body>
                @foreach ($data as $item)
                    <tr>
                        <x-table.body.column
                            class="border border-base-content text-center">{{ $loop->iteration }}</x-table.body.column>
                        <x-table.body.column
                            class="border border-base-content text-center">{{ $item->nip }}</x-table.body.column>
                        <x-table.body.column
                            class="border border-base-content text-center">{{ $item->nama }}</x-table.body.column>
                        <x-table.body.column class="border border-base-content text-center">
                            <div class="join">
