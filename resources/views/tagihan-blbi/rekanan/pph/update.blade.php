...
<div class="px-4">
    <form id="inputForm" action="/tagihan-blbi/{{ $tagihan->id }}/rekanan/{{ $rekanan->id }}/pph/{{ $data->id }}" method="post" autocomplete="off">
        @csrf
        @method('PATCH')
        ...
        <div>
            <a href="/tagihan-blbi/{{ $tagihan->id }}/rekanan/{{ $rekanan->id }}/pph"
                class="btn btn-xs btn-accent">Batal</a>
