...
<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row mb-3">
        <div class="col-lg-7">
            <a href="/bendahara/{{ $tagihan->id }}/payroll" class="btn btn-sm btn-outline-secondary mt-1 mb-1 ml-2">Sebelumnya</a>
        </div>
        <div class="col-lg-5">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
            <form action="/bendahara/{{ $tagihan->id }}/payroll/import" method="post" autocomplete="off">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
