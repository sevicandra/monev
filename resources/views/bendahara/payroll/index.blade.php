...
@section('content')
    ...
    <div class="flex flex-col md:flex-row px-4 gap-2 justify-between">
        <div>
            ...
            <a href="/bendahara/{{ $tagihan->id }}/payroll/create" class="btn btn-sm btn-neutral">Tambah</a>
            <a href="/bendahara/{{ $tagihan->id }}/payroll/import-hris" class="btn btn-sm btn-neutral">Import DB HRIS</a>
            <a href="/bendahara/{{ $tagihan->id }}/payroll/import-monev" class="btn btn-sm btn-neutral">Import DB Monev</a>
            <a href="/bendahara/{{ $tagihan->id }}/payroll/cetak" class="btn btn-sm btn-neutral" target="_blank">Cetak</a>
        </div>
        <div>
