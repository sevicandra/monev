    ...
    <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <div class="row mb-3">
            <div class="col-lg-7">
                ...
                <a href="/bendahara/{{ $tagihan->id }}/payroll/create" class="btn btn-sm btn-outline-secondary mt-1 mb-1 ml-2">Tambah</a>
                <a href="/bendahara/{{ $tagihan->id }}/payroll/import-hris" class="btn btn-sm btn-outline-secondary mt-1 mb-1 ml-2">Import DB HRIS</a>
                <a href="/bendahara/{{ $tagihan->id }}/payroll/import-monev" class="btn btn-sm btn-outline-secondary mt-1 mb-1 ml-2">Import DB Monev</a>
                <a href="/bendahara/{{ $tagihan->id }}/payroll/cetak" class="btn btn-sm btn-outline-secondary mt-1 mb-1 ml-2" target="_blank">Cetak</a>
            </div>
            <div class="col-lg-5">
                            ...
                            <tr>
                                ...
                                <td class="pb-0">
                                    <div class="btn-group btn-group-sm" role="group">
                                        <form action="/bendahara/{{ $item->tagihan_id }}/payroll/{{ $item->id }}" method="post">
                                            @csrf
                                            @method('DELETE')
