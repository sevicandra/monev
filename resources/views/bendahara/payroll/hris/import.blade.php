...
@section('content')
    ...
    <div class="flex flex-col md:flex-row px-4 gap-2 justify-between">
        <div class="">
            <a href="/bendahara/{{ $tagihan->id }}/payroll" class="btn btn-sm btn-neutral">Sebelumnya</a>
        </div>
        <div>
...
@section('foot')
    <dialog id="my_modal_3" class="modal">
        <div class="modal-box">
            ...
            <form id="inputPayroll" action="/bendahara/{{ $tagihan->id }}/payroll/import" method="post" autocomplete="off">
                @csrf
