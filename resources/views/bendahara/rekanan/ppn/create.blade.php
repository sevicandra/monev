...
@section('content')
    <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <form action="/bendahara/{{ $tagihan->id }}/rekanan/{{ $rekanan->id }}/ppn" method="post" autocomplete="off">
            @csrf
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" name="ntpn" class="form-control @error('ntpn') is-invalid @enderror" value="{{ old('ntpn') }}">
                        <div class="invalid-feedback">
                            @error('ntpn')
                                {{$message}}
                            @enderror
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="date" name="tanggalntpn" class="form-control @error('tanggalntpn') is-invalid @enderror" value="{{ old('tanggalntpn') }}">
                        <div class="invalid-feedback">
                            @error('tanggalntpn')
                                {{$message}}
                            @enderror
