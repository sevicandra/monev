...
@section('content')
    <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <div class="row mb-3">
            <div class="col-lg-7">
                <a href="/dashboard/unit/{{ $unit->id }}" class="btn btn-sm btn-outline-primary mt-1">Per Tagihan</a>
                <a href="/dashboard/unit/{{ $unit->id }}?sp2d=?" class="btn btn-sm btn-outline-primary mt-1 ml-2">Per SP2D</a>
            </div>
            <div class="col-lg-5">
            </div>
        </div>
