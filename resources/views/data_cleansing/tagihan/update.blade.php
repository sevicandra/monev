...
@section('content')
    ...
    <div class="px-4 gap-2 overflow-y-auto">
        <form action="/cleansing/tagihan/{{ $data->id }}" method="post" autocomplete="off">
            @csrf
            @method('PATCH')
            ...
            <div class="form-group">
                <a href="{{ url()->current() === url()->previous() ? '/cleansing/tagihan' : url()->previous() }}" class="btn btn-sm btn-accent">Batal</a>
