...
@section('content')
    <div class="bg-primary p-4">
        <h1 class="text-xl text-primary-content">KKP Belum Input SP2D</h1>
    </div>
    <div class="">
    ...
    <div class="flex flex-col md:flex-row px-4 gap-2 justify-between">
        <div class="">
            <a href="/cleansing/kkp/download" class="btn btn-sm btn-neutral">Download Rekap</a>
            <a href="/cleansing/kkp/import" class="btn btn-sm btn-neutral">Import</a>
        </div>
        <div class="">
