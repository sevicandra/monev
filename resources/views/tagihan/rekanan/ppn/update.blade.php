...
@section('content')
        ...
        <div class="px-4">
            <form id="inputForm" action="/tagihan/{{ $tagihan->id }}/rekanan/{{ $rekanan->id }}/ppn/{{ $data->id }}" method="post" autocomplete="off">
                @csrf
                @method('PATCH')
                ...
                <div class="form-group">
                    <a href="/tagihan/{{ $tagihan->id }}/rekanan/{{ $rekanan->id }}/ppn" class="btn btn-xs btn-accent">Batal</a>
