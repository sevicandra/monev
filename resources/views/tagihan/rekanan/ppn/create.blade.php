...
@section('content')
    ...
    <div class="px-4">
        <form id="inputForm" action="/tagihan/{{ $tagihan->id }}/rekanan/{{ $rekanan->id }}/ppn" method="post" autocomplete="off">
            @csrf
            ...
            <div>
                <a href="/tagihan/{{ $tagihan->id }}/rekanan/{{ $rekanan->id }}/ppn" class="btn btn-sm btn-accent">Batal</a>
