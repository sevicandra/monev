...
<div class="px-4">
    <form id="inputForm" action="/tagihan/{{ $tagihan->id }}/rekanan/{{ $rekanan->id }}/pph/{{ $data->id }}" method="post" autocomplete="off">
        @csrf
        @method('PATCH')
        ...
        <div>
            <a href="/tagihan/{{ $tagihan->id }}/rekanan/{{ $rekanan->id }}/pph"
