...
@section('content')
    <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <form action="/verifikasi/{{ $tagihan->id }}/rekanan/{{ $rekanan->id }}/ppn/{{ $data->id }}" method="post" autocomplete="off">
            @csrf
            @method('PATCH')
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="row mt-3">
                <div class="col">
                    <div class="form-group">
                        <a href="/verifikasi/{{ $tagihan->id }}/rekanan/{{ $rekanan->id }}/ppn" class="btn btn-sm btn-outline-secondary">Batal</a>
