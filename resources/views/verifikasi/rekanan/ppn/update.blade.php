...
@section('content')
        ...
        <div class="px-4">
            <form id="inputForm" action="/verifikasi/{{ $tagihan->id }}/rekanan/{{ $rekanan->id }}/ppn/{{ $data->id }}" method="post" autocomplete="off">
                @csrf
                @method('PATCH')
                ...
                <div class="form-group">
                    <a href="/verifikasi/{{ $tagihan->id }}/rekanan/{{ $rekanan->id }}/ppn" class="btn btn-sm btn-accent">Batal</a>
