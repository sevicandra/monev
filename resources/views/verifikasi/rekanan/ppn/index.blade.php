    ...
    <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <div class="row mb-3">
            <div class="col-lg-7">
                ...
                <a href="/verifikasi/{{ $tagihan->id }}/rekanan/{{ $rekanan->id }}/ppn/create" class="btn btn-sm btn-outline-secondary mt-1 mb-1 ml-2">Tambah</a>
            </div>
            <div class="col-lg-5">
                            ...
                            <tr>
                                ...
                                <td class="pb-0">
                                    <div class="btn-group btn-group-sm" role="group">
                                        <form action="/verifikasi/{{ $tagihan->id }}/rekanan/{{ $rekanan->id }}/ppn/{{ $item->id }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <a href="/verifikasi/{{ $tagihan->id }}/rekanan/{{ $rekanan->id }}/ppn/{{ $item->id }}/edit" class="btn btn-sm btn-outline-secondary pt-0 pb-0">edit</a>
                                    </div>
                                </td>
                            </tr>
                            @php
