                            ...
                            <tr>
                                ...
                                <td class="pb-0">
                                    <div class="btn-group btn-group-sm" role="group">
                                        @if ($item->nominal)
                                            <a href="/tagihan/{{ $data->id }}/dnp/{{ $item->id }}/nominal/{{ $item->nominal->id }}/update/" class="btn btn-sm btn-outline-secondary pt-0 pb-0">Nominal</a>
                                        @else
                                            <a href="/tagihan/{{ $data->id }}/dnp/{{ $item->id }}/nominal/" class="btn btn-sm btn-outline-secondary pt-0 pb-0">Nominal</a>
                                        @endif
                                        <form action="/tagihan/{{ $data->id }}/dnp/{{ $item->id }}" method="post">
                                            @csrf
                                            @method('DELETE')
