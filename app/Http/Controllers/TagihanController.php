...
class TagihanController extends Controller
{
    ...
    public function templateExcelPayroll()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('E1', 'PAJAK');
        $spreadsheet->setActiveSheetIndex(0)
            ->setCellValue('A2', '1')
            ->setCellValue('B2', '123456789')
            ->setCellValue('C2', 'xxxxxxxxxx')
            ->setCellValue('D2', '1000000')
            ->setCellValue('E2', '100000')
            ->setCellValue('F2', 'data contoh jangan di hapus');
        $spreadsheet->setActiveSheetIndex(0)->getStyle('A:F')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_TEXT);
        $spreadsheet->setActiveSheetIndex(0)->getStyle('D:E')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
        $spreadsheet->setActiveSheetIndex(0)->getStyle('D1:E1')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_TEXT);
        ...
        $spreadsheet->setActiveSheetIndex(1)
            ...
            ->setCellValue('D2', '1000000')
            ->setCellValue('E2', '100000')
            ->setCellValue('F2', '2900')
            ->setCellValue('G2', 'BRI/Mandiri/BSI dll')
            ->setCellValue('H2', 'data contoh jangan di hapus');
        $spreadsheet->setActiveSheetIndex(1)->getStyle('A:H')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_TEXT);
        $spreadsheet->setActiveSheetIndex(1)->getStyle('D:F')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
        $spreadsheet->setActiveSheetIndex(1)->getStyle('D1:F1')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_TEXT);
